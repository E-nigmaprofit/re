...
define('TOKEN', '5e316e43dce77419483596426329'); // Токен вебмастера
define('CAMPAIGN_HASH', '7edf45eb-80ba-4355-afab-6df7e64d292a'); // Хеш потока
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($body->success) {
        $schema = ($_SERVER['HTTPS'] == 'on') ? 'https://' : 'https://';
